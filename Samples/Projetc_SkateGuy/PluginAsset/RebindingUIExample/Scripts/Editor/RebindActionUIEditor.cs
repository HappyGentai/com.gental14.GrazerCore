...
namespace UnityEngine.InputSystem.LouiGCustom.RebindUI
{
    ...
    public class RebindActionUIEditor : UnityEditor.Editor
    {
        ...
        protected void OnEnable()
        {
            ...
            m_RebindTextProperty = serializedObject.FindProperty("m_DuplicateText");
            m_DuplicateTextProperty = serializedObject.FindProperty("m_RebindText");
        ...
        public override void OnInspectorGUI()
        {
            ...
            using (new EditorGUI.IndentLevelScope())
            {
                ...
                EditorGUILayout.PropertyField(m_DuplicateTextProperty);
            }
        ...
        private SerializedProperty m_DuplicateTextProperty;
